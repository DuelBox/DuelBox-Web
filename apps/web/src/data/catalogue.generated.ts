...
export const CATEGORIES: readonly string[] = ["Arcade", "Arena", "Board", "Deduction", "Dice", "Memory", "Party", "Platform", "Puzzle", "Racing", "Racing & Trails", "Reaction", "Rhythm", "Shooter", "Solo", "Sports", "Stealth", "Survival"] as const;
