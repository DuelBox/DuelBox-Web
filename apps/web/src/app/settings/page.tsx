    ...
    <div className="db-wrap">
      <header className={styles.head}>
        ...
        <p className={styles.lede}>
          Sound, vibration, and what this device remembers about how you play. Every change applies
          straight away and is kept in this browser only — nothing here is sent anywhere.
        </p>
      </header>
      <SettingsPanel />
    </div>
