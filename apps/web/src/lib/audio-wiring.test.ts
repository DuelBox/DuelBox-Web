 ...
 * assertion catches.
 *
 * The behaviour of the audio helpers themselves is covered in `audio.test.ts`; this file
 * only checks that the shell reaches them. If this test is in your way because you are
 * deliberately removing audio from the shell, delete it in the same commit and say so in
 * the message. That is the difference between a decision and an accident, and only one of
 * those needs catching.
 */
